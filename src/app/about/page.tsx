...
export const metadata: Metadata = {
  ...
  description:
    "SENZA — кураторы чувств в Астане. Отбираем ароматы, уход и подарки, которые раскрывают тебя.",
};
    ...
    <div className="min-h-screen bg-[#FAF5ED] pt-20">
      ...
      >
        ...
        <div className="max-w-5xl mx-auto px-6 lg:px-10 relative z-10">
          ...
          >
            Мы — кураторы<br />
            <em className="text-[#C4956A]" style={{ fontStyle: "italic" }}>чувств.</em>
          </h1>
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-10 py-28 lg:py-40">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center mb-32 lg:mb-44">
          <div className="space-y-6">
            ...
            <p className="text-[#1A1814]/50 leading-[1.8] text-[15px]">
              ...
              которые действительно работают. Без маркетинговых обещаний — только результат.
            </p>
          </div>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            >
              &laquo;Каждый заслуживает аромат, который раскрывает его характер&raquo;
            </p>
          </div>
        </section>
        ...
        <section className="space-y-14 mb-32 lg:mb-44">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              {
                title: "Ароматы",
                desc: "8+ ароматов, отобранных нашими кураторами. Восточные, цветочные, древесные — каждый раскрывает разное настроение.",
                price: "от 4 500 ₸",
              },
              {
                title: "Уход",
                desc: "Корейская косметика, которая работает. Многоступенчатый уход, ампулы, кремы с реальным результатом.",
                price: "от 800 ₸",
              },
              {
                title: "Подарки",
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-[#E8E2D8]/40 text-sm leading-relaxed">
            <p>
              ...
              самостоятельная коллекция, созданная в определённых семействах нот.
              Мы не продаём подделки — мы курируем ароматы.
            </p>
            <p>
