...
import { WHATSAPP_NUMBERS } from "@/data/products";
...
const CONTACTS: ContactCard[] = [
  {
    ...
    iconPath: WA_ICON_PATH,
  },
  {
    platform: "WhatsApp 2",
    handle: "+7 (771) 222-22-45",
    description: "Быстрый заказ и консультация. Отвечаем в течение часа.",
    href: `https://wa.me/${WHATSAPP_NUMBERS[1].number}`,
    cta: "Написать в WhatsApp",
    iconPath: WA_ICON_PATH,
  },
  {
    platform: "WhatsApp 3",
    handle: "+7 (705) 444-32-31",
    description: "Быстрый заказ и консультация. Отвечаем в течение часа.",
    href: `https://wa.me/${WHATSAPP_NUMBERS[2].number}`,
    cta: "Написать в WhatsApp",
    iconPath: WA_ICON_PATH,
  },
  {
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
              {[
                ...
                { num: "03", title: "Получите", desc: "Оплата при получении — обсудим в WhatsApp" },
              ].map((s, i) => (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          >
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm text-[#1A1814]/70">Оплата при получении</p>
                <p className="text-[#1A1814]/35 text-[12px]">Обсудим при заказе</p>
              </div>
            </div>
            <div className="w-10 h-px bg-[#C4956A]/20" />
            <p className="text-[#1A1814]/45 text-sm leading-relaxed">
              Оплату обсудим в WhatsApp при оформлении заказа.
            </p>
          </div>
        </div>
      </div>
