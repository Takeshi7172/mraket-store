...
const TESTIMONIALS: Testimonial[] = [
  {
    name: "Айгерим",
    age: 24,
    text: "Barakkat Rouge — мой повседневный аромат. Комплименты каждый день, а стоит как ужин в ресторане.",
  },
  {
    name: "Данияр",
    age: 28,
    text: "Взял BLEU for Men и Tobacco Vanille. Качество на уровне оригинала. Третий получил в подарок по акции 2+1.",
  },
  {
    name: "Мадина",
    age: 31,
    text: "Заказала набор Gift для подруги. Упаковка красивая, аромат шикарный. Теперь хочу себе.",
  },
  {
    name: "Асем",
    age: 22,
    text: "4-in-1 крем — лучшее, что случалось с моей кожей. Увлажняет весь день.",
  },
];
