...
const FLOATING_DOTS = [
  { top: "22%", left: "12%", delay: 0, duration: 7 },
  { top: "65%", left: "8%", delay: 1.5, duration: 9 },
  { top: "35%", right: "10%", delay: 0.8, duration: 8 },
  { top: "72%", right: "15%", delay: 2.1, duration: 10 },
  { top: "18%", right: "28%", delay: 0.4, duration: 11 },
  { top: "55%", left: "22%", delay: 1.2, duration: 8.5 },
];
    ...
    >
      ...
      >
        ...
        <motion.p
          ...
          className="text-[#C9A96E] text-xs tracking-[0.5em] uppercase mb-8"
        >
          SENSO COLLECTION
        </motion.p>
        ...
        <motion.h1
          variants={ITEM_VARIANTS}
          className="font-heading text-6xl sm:text-7xl lg:text-8xl xl:text-9xl text-[#F5F5F0] leading-none tracking-tight mb-6"
        >
          Почувствуй,
          <br />
        ...
        <motion.p
          variants={ITEM_VARIANTS}
          className="text-[#F5F5F0]/55 text-lg sm:text-xl max-w-xl leading-relaxed mb-8"
        >
        ...
        >
          <Link
            href="/catalog"
            className="inline-flex items-center gap-2 bg-[#C9A96E] text-[#0A0A0A] px-10 py-4 text-sm tracking-widest uppercase font-medium hover:bg-[#e0c080] transition-colors duration-300"
          >
            Смотреть каталог
          </Link>
          <a
            ...
            className="inline-flex items-center gap-2 border border-[#F5F5F0]/25 text-[#F5F5F0]/80 px-10 py-4 text-sm tracking-widest uppercase hover:border-[#C9A96E] hover:text-[#C9A96E] transition-colors duration-300"
        ...
        >
          <span className="flex items-center gap-1.5 text-[#F5F5F0]/45">
          ...
          <span className="inline-flex items-center gap-1 bg-[#C9A96E]/12 border border-[#C9A96E]/25 text-[#C9A96E] px-3 py-1 tracking-wider uppercase text-[10px]">
      ...
      >
        <span className="text-[#F5F5F0]/30 text-[10px] tracking-[0.4em] uppercase">
          Листать
        </span>
        <motion.div
          animate={{ y: [0, 6, 0] }}
