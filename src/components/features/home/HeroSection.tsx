  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-[#1A1814]/70 text-base sm:text-lg leading-relaxed mb-10 max-w-sm">
        ...
        <div className="flex flex-col sm:flex-row items-center lg:items-start gap-4 w-full sm:w-auto">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2.5 border border-[#1A1814]/20 text-[#1A1814]/65 px-10 py-4 text-[11px] tracking-[0.3em] uppercase hover:border-[#C4956A]/50 hover:text-[#C4956A] transition-all duration-300 w-full sm:w-auto"
          >
