...
export function Footer() {
  return (
    <footer className="bg-[#0A0A0A] text-[#F5F5F0]/60">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs text-[#C9A96E] uppercase tracking-widest">
              Астана, Казахстан
            </p>
          </div>
          ...
          {/* Navigation column */}
          <div className="space-y-4">
            <h3 className="text-[#F5F5F0] text-xs tracking-widest uppercase mb-4">
              Навигация
            </h3>
            <nav className="flex flex-col gap-3" aria-label="Навигация в подвале">
              {[
                ...
                <Link
                  key={link.href}
                  href={link.href}
                  className="text-sm hover:text-[#C9A96E] transition-colors"
                >
                  {link.label}
                </Link>
              ))}
            ...
            <div className="flex items-center gap-4 pt-2">
              {SOCIAL_LINKS.map((social) => (
                <a
                  ...
                  className="text-[#F5F5F0]/40 hover:text-[#C9A96E] transition-colors"
                >
                  {social.icon}
                </a>
              ))}
